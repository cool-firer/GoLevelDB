...
func (o *Options) GetCompactionExpandLimit(level int) int {
	factor := DefaultCompactionExpandLimitFactor // 25
...
func (o *Options) GetCompactionGPOverlaps(level int) int {
	factor := DefaultCompactionGPOverlapsFactor // 10
...
func (o *Options) GetCompactionSourceLimit(level int) int {
	factor := DefaultCompactionSourceLimitFactor // 1
...
func (o *Options) GetCompactionTableSize(level int) int {
	var (
		base = DefaultCompactionTableSize // 2 * MiB
		mult float64
	)
	if o != nil {
...
func (o *Options) GetCompactionTotalSize(level int) int64 {
	var (
		base = DefaultCompactionTotalSize // 10MiB
		mult float64
	)
	if o != nil {
